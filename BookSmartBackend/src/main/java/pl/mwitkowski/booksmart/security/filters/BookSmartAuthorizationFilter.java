...
@Slf4j
public class BookSmartAuthorizationFilter extends OncePerRequestFilter {

    public static void setErrorResponse(HttpServletResponse response, String exceptionMessage) throws IOException {
